        ...
        <nav className="prenavBar relative h-11">
          <div className="logoSection">
            <img
              src={logoName}
              alt="SoleRangers"
              className="h-6 mx-auto text-center self-center cursor-pointer"
              onClick={() => navigate("/")}
            />
          </div>
        ...
        <div className="mainNav">
          <div className="container-lg mainnav" id="home">
            <ul className="mainnav__list">
              <li className="mainNav__listItem" onClick={() => navigate("/")}>
                {" "}
                HOME{" "}
              </li>
              <li
                className="mainNav__listItem disable"
                onClick={() => navigate("/underWorking")}
              >
                {" "}
                APPARELS{" "}
              </li>
              ...
              <li
                className="mainNav__listItem disabel"
                onClick={() => navigate("/underWorking")}
              >
                {" "}
                DUNKS
