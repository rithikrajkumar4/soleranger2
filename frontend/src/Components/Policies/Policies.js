...
function Policies() {
   ...
   return (
    <>
        <Navbar/>
        <div className='container-lg policies__container'>
            <div className="row policy__row">
                <div className="col-12 policy__col">
                    <h1 className="policy__heading" id='terms'> Terms and Conditions </h1>
                    <hr />
                </div>
                <div className="col-12 policy__content">
                    <p className='policy__para'>
                    This website is operated by The Solerangers. Throughout the site, the terms “we”, “us” and “our” refer to The Solerangers. The Solerangers offers this website, including all information, tools and services available from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies and notices stated here.
                        ...
                        <br /> <br />
                        <h5>SECTION 5 - PRODUCTS OR SERVICES</h5> (if applicable) 
                        Certain products or services may be available exclusively online through the website. These products or services may have limited quantities and are subject to return or exchange only according to our Return Policy. 
                        We have made every effort to display as accurately as possible the colors and images of our products that appear at the store. We cannot guarantee that your computer m ,onitor's display of any color will be accurate. 
                        ...
                        In no case shall The Solerangers, our directors, officers, employees, affiliates, agents, contractors, interns, suppliers, service providers or licensors be liable for any injury, loss, claim, or any direct, indirect, incidental, punitive, special, or consequential damages of any kind, including, without limitation lost profits, lost revenue, lost savings, loss of data, replacement costs, or any similar damages, whether based in contract, tort (including negligence), strict liability or otherwise, arising from your use of any of the service or any products procured using the service, or for any other claim related in any way to your use of the service or any product, including, but not limited to, any errors or omissions in any content, or any loss or damage of any kind incurred as a result of the use of the service or any content (or product) posted, transmitted, or otherwise made available via the service, even if advised of their possibility. Because some states or jurisdictions do not allow the exclusion or the limitation of liability for consequential or incidental damages, in such states or jurisdictions, our liability shall be limited to the maximum extent permitted by law. 
                        <br /> <br />
                        <h5>SECTION 14 - INDEMNIFICATION </h5>
                        You agree to indemnify, defend and hold harmless The Solerangers and our parent, subsidiaries, affiliates, partners, officers, directors, agents, contractors, licensors, service providers, subcontractors, suppliers, interns and employees, harmless from any claim or demand, including reasonable attorneys’ fees, made by any third-party due to or arising out of your breach of these Terms of Service or the documents they incorporate by reference, or your violation of any law or the rights of a third-party. 
                        <br /> <br />
            ...
            <div className="row policy__row">
                <div className="col-12 policy__col">
                    <h1 className="policy__heading" id='seller'> Seller Policy </h1>
                    <hr />
                </div>
                <div className="col-12 policy__content">
                    <p className='policy__para'> 
                    <ul className="seller__list">
                        <li className="seller__listItem">
                        In order to sell with us, your item must be shipped into us to legit check.
                        </li>
                        <li className="seller__listItem">
                        Once your item is legit checked and approved, we will give you an appraisal and recommend a selling price.
                        </li>
                        <li className="seller__listItem">
                        Once we decide upon a selling price, a commission will be fixed.
                        </li>
                        <li className="seller__listItem">
                        Post this, it will be listed in-store and online within 7-14 days.
                        </li>
                        <li className="seller__listItem">
                        The item must be stocked with us for a minimum period of 30 days, post which the product can be called back, either picked up in-store - or upon paying the shipping fee.
                        </li>
                        <li className="seller__listItem">
                        If you want to call for the item back earlier than 30 days, there will be a mandatory early withdrawal fee of INR 1,999/-.
                        </li>
                        <li className="seller__listItem">
                        If the item turns out to be fake, there will be a fee of INR 2000/- to send it back.
                        </li>
                        <li className="seller__listItem">
            ...
            <div className="row policy__row">
                <div className="col-12 policy__col">
                    <h1 className="policy__heading" id='privacy'> Privacy Policy </h1>
                    <hr />
                </div>
                <div className="col-12 policy__content">
                    <p className='policy__para'> 
                    This Privacy Policy describes how your personal information is collected, used, and shared when you visit or make a purchase from marketplace.mainstreet.co.in (the “Site”). 
...
Your rights 
If you are an Indian resident, you have the right to access personal information we hold about you and to ask that your personal information be corrected, updated, or deleted. If you would like to exercise this right, please contact us through the contact information below. 
...
We may update this privacy policy from time to time in order to reflect, for example, changes to our practices or for other operational, legal or regulatory reasons. 
            ...
            <div className="row policy__row">
                <div className="col-12 policy__col">
                    <h1 className="policy__heading" id='shipping'> Shipping Policy </h1>
                    <hr />
                </div>
                <div className="col-12 policy__content">
                    <p className='policy__para'> 
                    Solerangers ("we" and "us") is the operator of
                        (https://marketplace.mainstreet.co.in) ("Website"). By placing an order through this Website you will be agreeing to the terms below. These are provided to ensure both parties are aware of and agree upon this arrangement to mutually protect and set expectations on our service.
                        1. General
                        ...
                        The Solerangers accepts no returns and offers no refunds.
                        3.2 Warranty Returns
                        Solerangers will happily honor any valid warranty claims, provided a claim is submitted within 90 days of receipt of items.
                        Customers will be required to pre-pay the return shipping, however we will reimburse you upon successful warranty claim.
                        Upon return receipt of items for warranty claim, you can expect The Solerangers to process your warranty claim within 7 days.
                        ...
                        Solerangers will ship to P.O. box addresses using postal services
            ...
            <div className="row policy__row">
                <div className="col-12 policy__col">
                    <h1 className="policy__heading" id='return'> Return Policy </h1>
                    <hr />
                </div>
                <div className="col-12 policy__content">
                    <p className='policy__para'> 
                    We don’t accept any returns/exchange or offer refunds/exchange. Sales once made are final and the sole responsibility of the purchasing party.
                    </p>
                </div>
            </div>
